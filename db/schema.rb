...
ActiveRecord::Schema.define(version: 20170610235929) do
  ...
  create_table "inventions_other_materials", id: false, force: :cascade do |t|
    ...
    t.index ["invention_id"], name: "index_inventions_other_materials_on_invention_id", using: :btree
    t.index ["other_material_id"], name: "index_inventions_other_materials_on_other_material_id", using: :btree
  end
